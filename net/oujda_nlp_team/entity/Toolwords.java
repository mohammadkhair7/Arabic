   ...
   public class Toolwords implements Serializable {
     ...
     public void setClassProclitic(String _procClass) {
       this.procClass = _procClass;
     }
     
     public void setClassEnclitic(String _encClass) {
       this.encClass = _encClass;
     }
     ...
     public String getVoweledform() {
       return this.voweledform;
     }
     
     public String getClassProclitic() {
       return this.procClass;
     }
     
     public String getClassEnclitic() {
